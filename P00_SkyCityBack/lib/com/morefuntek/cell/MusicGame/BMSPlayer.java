...
//    /**音符MISS的范围，单位 x分之一拍 。在lostscope之后没有按，音符算丢失。*/
//    public int LostScope = 1;//delta
...
//-------------------------------------------------------------------------------------------------
    ...
    public BMSPlayer (
        ...
        try {
            ...
            String data = new String(com.morefuntek.cell.CIO.loadFile(bmsFile));
