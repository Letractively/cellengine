...
//
#ifndef _MF_GAME_OBJECT
#define _MF_GAME_OBJECT
...
namespace mf
{
	 ...
	 * @version 1.0
	 */
	class CC_DLL  CCollides : public CGroup
	{		
	protected :
	...
	public:
		 ...
		 * @param color 
		 */
		void render(Graphics2D *g, int index, Color const &color);
	 ...
	 * @version 1.0
	 */
	class CC_DLL  CAnimates : public CGroup
	{
	protected:
	...
	public:
		 ...
		 */
		CAnimates(int partCount, ITiles *tils);
		 ...
		 */
		void render(Graphics2D *g, int index);
