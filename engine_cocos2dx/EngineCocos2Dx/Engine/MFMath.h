...
namespace mf
{
	...
	const s32 MF_INT32_MAX			= 2147483647;
	const s32 MF_INT32_MIN			= -2147483647;
    ...
    public:
		 ...
		 * 两向量距离
		 */
		static float getDistance4F(float x1, float y1, float x2, float y2);

		/**
		 * (0,0)点和此向量距离
		 */
		static float getDistanceV(Vector2D const &v);
