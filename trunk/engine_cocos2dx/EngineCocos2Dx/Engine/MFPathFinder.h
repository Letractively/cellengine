	...
	*/
	...
	public:
		...
		*/
		...
		class WayPoint implements Iterable<WayPoint>, Serializable
		{
		...
		class WayPointIterator implements Iterator<WayPoint>
		{
			WayPoint wp ;
