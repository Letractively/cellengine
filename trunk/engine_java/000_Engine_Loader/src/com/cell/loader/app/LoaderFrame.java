...
public abstract class LoaderFrame extends JFrame implements WindowListener, LoadTask.LoadTaskListener
{
	...
	private LinkedHashMap<String, byte[]>	
							local_jar_files 	= new LinkedHashMap<String, byte[]>();
				...
				try
				{
					...
					if (file.exists()) 
					{
						...
						if (remote_md5.equals(local_md5)) {
							update_val.remove(remote_file); // remove remote file
	...
	abstract protected void onTaskInit(Map<String, String> config_file);
	...
	final public boolean isIgnore(String file_name) {
