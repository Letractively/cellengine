...
public abstract class SunGraphicsEnvironment extends GraphicsEnvironment
                    ...
                    try {
                        ...
                        if (ver > 5.10f) {
                            ...
                            if (line.indexOf("OpenSolaris") >= 0) {
                                ...
                                /* "Solaris Next" (03/10) is missing the fonts
                                 * expected by this release's fontconfig file.
                                 * So if they aren't there, then we must
                                 * also use the OpenSolaris font mapping.
                                 * Look for Courier New as lack of a monospaced
                                 * font is what seems to get noticed first.
                                 */
                                String courierNew =
	...
	registerPlatformFontsUsedByFontConfiguration();
	     ...
	     * fall back component fonts to the composite.
             * For OpenSolaris we will specify that only the first font
             * should be used to generate overall metrics. This is because
             * OpenSolaris emphasises UTF-8 encoding locales.
	     */
	    if (altNameCache != null) {
		FontManager.registerCompositeFont(
		    descriptor.getFaceName(),
                    componentFileNames, componentFaceNames,
		    isOpenSolaris ? 1 : descriptor.getCoreComponentCount(),
