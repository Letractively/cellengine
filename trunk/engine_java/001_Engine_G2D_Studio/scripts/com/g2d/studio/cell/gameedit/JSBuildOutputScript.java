 ...
 * @author zhangyifei
 */
public interface JSBuildOutputScript 
{
	/**
	 * 是否决定使用此导出脚本。
	 ...
	 * @param output_script		 选择的导出脚本
	 */
	public void	selectOuputScript(BuildProcess p, File dir, File cpj_file_name, List<String> output_script);
