...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i ) 
				values[i] = BigIODeserialize.getString(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			String[] values = new String[count];
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getString(istream, charset);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getBoolean(istream);
			return values;
		}
	}	
...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getByte(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getUnsignedByte(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			short[] values = new short[count];
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getShort(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getUnsignedShort(istream);
			return values;
		}
	}	
...
//		synchronized (lock_read)
		{
			...
			int[] values = new int[count];
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getInt(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getUnsignedInt(istream);
			return values;
		}
	}
...
//		synchronized (lock_read)
		{
			...
			long[] values = new long[count];
			for ( int i=0; i<count; ++i )
				values[i] = BigIODeserialize.getLong(istream);
			return values;
		}
	}
...
//	---------------------------------------------------------------------------------------------------------------------------------
	...
	public BigIODeserialize(InputStream is) 
	{
		istream = is;
	}
	protected BigIODeserialize() {}
