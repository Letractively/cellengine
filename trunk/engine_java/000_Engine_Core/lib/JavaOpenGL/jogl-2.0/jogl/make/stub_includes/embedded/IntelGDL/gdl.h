...
/**@mainpage
 * This document is applicable to the Intel(R) Media Processor CE 3100 and the
 * CE4100 processor. In this document, both processors are referred to as
 * the Intel(R) CE Media Processors. When functional differences occur,
...
gdl_set_display_info(
    ...
    - Since HDMI audio signals are carried within the video signals, 
      ...
      the Intel® CE Media Processors SMD C-API Programmer’s Guide for
