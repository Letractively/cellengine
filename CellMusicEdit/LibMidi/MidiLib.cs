...
namespace Cell.LibMidi
{
	...
	public class HeaderChunk 
	{
        ...
        public Int16 MidiType = 0;
        public Int16 Tracks = 0;
        public Int16 Division = 0;
		...
		public Int32 LoadChunkData(byte[] data,Int32 p)
		{
            ...
            Console.WriteLine("HeaderSize  : "+ DataSize);

			MidiType = Midi.readMSB16(data,P);P+=2;
			Tracks   = Midi.readMSB16(data,P);P+=2;
			Division = Midi.readMSB16(data,P);P+=2;

			Console.WriteLine("Midi Format : "+this.MidiType);
			Console.WriteLine("Traks       : "+this.Tracks);
			...
			else
			{
				...
				Console.WriteLine("SMPTE FPS   : "+this.Smpte_fps);
				Console.WriteLine("SMPTE TPF   : "+this.Smpte_tpf);
			}
            return DataSize + 4;
		}
	};
	...
	public class Midi
	{
        ...
        /// <param>	  data[]
        /// <param>   value
        public static void write8(byte[] data, Int32 p, byte val)
        {
            data[p++] = val;
        }
        ...
        /// <param>	  data[]
        /// <param>   value
        public static void write16(byte[] data, Int32 p, Int16 val)
        {
            data[p++] = (byte)(val >> 0);
            data[p++] = (byte)(val >> 8);
        }
        ...
        /// <param>	  data[]
        /// <param>   value
        public static void write24(byte[] data, Int32 p, Int32 val)
        {
            data[p++] = (byte)(val >> 0);
            data[p++] = (byte)(val >> 8);
            data[p++] = (byte)(val >> 16);
        ...
        /// <param>	  data[]
        /// <param>   value
        public static void write32(byte[] data, Int32 p, Int32 val)
        {
            data[p++] = (byte)(val >> 0);
            data[p++] = (byte)(val >> 8);
            data[p++] = (byte)(val >> 16);
        ...
        /// <param>   p         位置
        /// <return>  
        public static byte read8(byte[] data, Int32 p)
        {
            return data[p++];
        }
        ...
        /// <param>   p         位置
        /// <return>  
        public static Int16 read16(byte[] data, Int32 p)
        {
            Int16 val = 0;
            val += (Int16)(data[p++] << 0);
            val += (Int16)(data[p++] << 8);
        ...
        /// <param>   p         位置
        /// <return>  
        public static Int32 read24(byte[] data, Int32 p)
        {
            Int32 value = 0;
            value += data[p++] << 0;
            value += data[p++] << 8;
        ...
        /// <param>   p         位置
        /// <return>  
        public static Int32 read32(byte[] data, Int32 p)
        {
            Int32 value = 0;
            value += data[p++] << 0;
            value += data[p++] << 8;
		...
		/// <param>	  data[]
		/// <param>   value
		public static void writeMSB8(byte[] data,Int32 p,byte  val)
		{
			data[p++] = val;
		}
		/// <summary> 往一个data数组里写一个Int16
		/// <param>	  data[]
		/// <param>   value
		public static void writeMSB16(byte[] data,Int32 p,Int16 val)
		{
			data[p++] = (byte)(val>>8);
			data[p++] = (byte)(val>>0);
		}
		...
		/// <param>	  data[]
		/// <param>   value
		public static void writeMSB32(byte[] data,Int32 p,Int32 val)
		{
			data[p++] = (byte)(val>>24);
			data[p++] = (byte)(val>>16);
			data[p++] = (byte)(val>>8) ;
