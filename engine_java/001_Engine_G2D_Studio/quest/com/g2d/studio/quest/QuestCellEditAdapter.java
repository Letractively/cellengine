...
import com.cell.rpg.quest.QuestItem.TagBattleWin;
...
//	-------------------------------------------------------------------------------------------------------------------------
	...
	public static class QuestTriggerAdapter extends AbilityCellEditAdapter<QuestTrigger>
	{
		...
		public PropertyCellEdit<?> getCellEdit(ObjectPropertyEdit owner, Object editObject, Object fieldValue, Field field) 
		{
			...
			{
				QuestSelectCellEdit edit 
					= new QuestSelectCellEdit(AbstractDialog.getTopWindow(owner.getComponent()), false, (Integer)fieldValue);
				edit.showDialog();
				return edit;
			}
...
//	-------------------------------------------------------------------------------------------------------------------------
	...
	public static class QuestItemTagQuest extends AbilityCellEditAdapter<TagQuest>
	{
		...
		public PropertyCellEdit<?> getCellEdit(ObjectPropertyEdit owner, Object editObject, Object fieldValue, Field field) 
		{
			...
			{
				QuestSelectCellEdit edit 
					= new QuestSelectCellEdit(owner.getComponent(), true, (Integer)fieldValue);
				edit.showDialog();
				return edit;
			}
	...
	public static class QuestItemTagQuestStateKillMonsterComparison extends AbilityCellEditAdapter<TagQuestStateKillMonsterComparison>
	{
		...
		public PropertyCellEdit<?> getCellEdit(ObjectPropertyEdit owner, Object editObject, Object fieldValue, Field field) 
		{
			...
			{
				ObjectSelectCellEditInteger<XLSUnit> edit 
					= new ObjectSelectCellEditInteger<XLSUnit>(owner.getComponent(), XLSUnit.class, fieldValue);
				edit.showDialog();
				return edit;
			}
	...
	public static class QuestItemTagItem extends AbilityCellEditAdapter<TagItem>
	{
		...
		public PropertyCellEdit<?> getCellEdit(ObjectPropertyEdit owner, Object editObject, Object fieldValue, Field field) 
		{
			...
			{
				ObjectSelectCellEditInteger<XLSItem> item_edit 
					= new ObjectSelectCellEditInteger<XLSItem>(owner.getComponent(), XLSItem.class, fieldValue);
...
//	}
	 ...
	 * @author WAZA
	 */
	public static class QuestItemTagBattleWin extends AbilityCellEditAdapter<TagBattleWin>
	{
		@Override
		public Class<TagBattleWin> getType() 
		{
			return TagBattleWin.class;
		}
