...
public class HtmlEditor extends JFrame implements ActionListener
{
	...
	public void init() {
		...
		JMenu colorMenu = new JMenu("颜色"); // 颜色
		JMenu fontMenu = new JMenu("字体"); // 字体
		JMenu styleMenu = new JMenu("样式"); // 样式
		JMenu alignMenu = new JMenu("对齐"); // 对齐
		...
		JMenuItem newItem = new JMenuItem("新建", new ImageIcon(
		...
		subscriptMenuItem.setText("下标");
		superscriptMenuItem.setText("上标");
		...
		JMenuItem leftAlignMenuItem = new JMenuItem(
				new StyledEditorKit.AlignmentAction("左对齐",
						StyleConstants.ALIGN_LEFT));
		JMenuItem centerMenuItem = new JMenuItem(
				new StyledEditorKit.AlignmentAction("居中",
						StyleConstants.ALIGN_CENTER));
		JMenuItem rightAlignMenuItem = new JMenuItem(
				new StyledEditorKit.AlignmentAction("右对齐",
						StyleConstants.ALIGN_RIGHT));

		leftAlignMenuItem.setText("左对齐");
		centerMenuItem.setText("居中");
...
//		JPanel editorControlPanel = new JPanel();
		...
		editorControlPanel.setFloatable(false);
...
//		JToolBar specialPanel = new JToolBar();
		JToolBar specialPanel = editorControlPanel;
		specialPanel.setFloatable(false);
...
//		alignPanel.setLayout(new FlowLayout());
		JToolBar alignPanel = editorControlPanel;
