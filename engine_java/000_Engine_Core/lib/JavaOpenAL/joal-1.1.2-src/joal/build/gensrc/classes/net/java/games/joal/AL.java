/* !---- DO NOT EDIT: This file autogenerated by com/sun/gluegen/procaddress/ProcAddressEmitter.java on Thu May 22 03:14:23 PDT 2008 ----! */
...
public interface AL extends ALConstants
{
  ...
  public void alAuxiliaryEffectSlotfv(int asid, int param, java.nio.FloatBuffer values);
  ...
  public void alAuxiliaryEffectSlotiv(int asid, int param, java.nio.IntBuffer values);
  ...
  public void alBufferData(int bid, int format, java.nio.Buffer data, int size, int freq);
  ...
  public void alBufferfv(int bid, int param, java.nio.FloatBuffer values);
  ...
  public void alBufferiv(int bid, int param, java.nio.IntBuffer values);
  ...
  public void alDeleteAuxiliaryEffectSlots(int n, java.nio.IntBuffer slots);
  ...
  public void alDeleteBuffers(int n, java.nio.IntBuffer buffers);
  ...
  public void alDeleteEffects(int n, java.nio.IntBuffer effects);
  ...
  public void alDeleteFilters(int n, java.nio.IntBuffer filters);
  ...
  public void alDeleteSources(int n, java.nio.IntBuffer sources);
  ...
  public void alEffectfv(int eid, int param, java.nio.FloatBuffer values);
  ...
  public void alEffectiv(int eid, int param, java.nio.IntBuffer values);
  ...
  public void alFilterfv(int fid, int param, java.nio.FloatBuffer values);
  ...
  public void alFilteriv(int fid, int param, java.nio.IntBuffer values);
  ...
  public void alGenAuxiliaryEffectSlots(int n, java.nio.IntBuffer slots);
  ...
  public void alGenBuffers(int n, java.nio.IntBuffer buffers);
  ...
  public void alGenEffects(int n, java.nio.IntBuffer effects);
  ...
  public void alGenFilters(int n, java.nio.IntBuffer filters);
  ...
  public void alGenSources(int n, java.nio.IntBuffer sources);
  ...
  public void alGetAuxiliaryEffectSlotf(int asid, int pname, java.nio.FloatBuffer value);
  ...
  public void alGetAuxiliaryEffectSlotfv(int asid, int pname, java.nio.FloatBuffer values);
  ...
  public void alGetAuxiliaryEffectSloti(int asid, int pname, java.nio.IntBuffer value);
  ...
  public void alGetAuxiliaryEffectSlotiv(int asid, int pname, java.nio.IntBuffer values);
  ...
  public void alGetBooleanv(int param, java.nio.ByteBuffer data);
  ...
  public void alGetBuffer3f(int bid, int param, java.nio.FloatBuffer value1, java.nio.FloatBuffer value2, java.nio.FloatBuffer value3);
  ...
  public void alGetBuffer3i(int bid, int param, java.nio.IntBuffer value1, java.nio.IntBuffer value2, java.nio.IntBuffer value3);
  ...
  public void alGetBufferf(int bid, int param, java.nio.FloatBuffer value);
  ...
  public void alGetBufferfv(int bid, int param, java.nio.FloatBuffer values);
  ...
  public void alGetBufferi(int bid, int param, java.nio.IntBuffer value);
  ...
  public void alGetBufferiv(int bid, int param, java.nio.IntBuffer values);
  ...
  public void alGetDoublev(int param, java.nio.DoubleBuffer data);
  ...
  public void alGetEffectf(int eid, int pname, java.nio.FloatBuffer value);
  ...
  public void alGetEffectfv(int eid, int pname, java.nio.FloatBuffer values);
  ...
  public void alGetEffecti(int eid, int pname, java.nio.IntBuffer value);
  ...
  public void alGetEffectiv(int eid, int pname, java.nio.IntBuffer values);
  ...
  public int alGetEnumValue(java.lang.String ename);
  ...
  public void alGetFilterf(int fid, int pname, java.nio.FloatBuffer value);
  ...
  public void alGetFilterfv(int fid, int pname, java.nio.FloatBuffer values);
  ...
  public void alGetFilteri(int fid, int pname, java.nio.IntBuffer value);
  ...
  public void alGetFilteriv(int fid, int pname, java.nio.IntBuffer values);
  ...
  public void alGetFloatv(int param, java.nio.FloatBuffer data);
  ...
  public void alGetIntegerv(int param, java.nio.IntBuffer data);
  ...
  public void alGetListener3f(int param, java.nio.FloatBuffer value1, java.nio.FloatBuffer value2, java.nio.FloatBuffer value3);
  ...
  public void alGetListener3i(int param, java.nio.IntBuffer value1, java.nio.IntBuffer value2, java.nio.IntBuffer value3);
  ...
  public void alGetListenerf(int param, java.nio.FloatBuffer value);
  ...
  public void alGetListenerfv(int param, java.nio.FloatBuffer values);
  ...
  public void alGetListeneri(int param, java.nio.IntBuffer value);
  ...
  public void alGetListeneriv(int param, java.nio.IntBuffer values);
  ...
  public void alGetSource3f(int sid, int param, java.nio.FloatBuffer value1, java.nio.FloatBuffer value2, java.nio.FloatBuffer value3);
  ...
  public void alGetSource3i(int sid, int param, java.nio.IntBuffer value1, java.nio.IntBuffer value2, java.nio.IntBuffer value3);
  ...
  public void alGetSourcef(int sid, int param, java.nio.FloatBuffer value);
  ...
  public void alGetSourcefv(int sid, int param, java.nio.FloatBuffer values);
  ...
  public void alGetSourcei(int sid, int param, java.nio.IntBuffer value);
  ...
  public void alGetSourceiv(int sid, int param, java.nio.IntBuffer values);
  ...
  public java.lang.String alGetString(int param);
  ...
  public boolean alIsExtensionPresent(java.lang.String extname);
  ...
  public void alListenerfv(int param, java.nio.FloatBuffer values);
  ...
  public void alListeneriv(int param, java.nio.IntBuffer values);
  ...
  public void alSourcePausev(int ns, java.nio.IntBuffer sids);
  ...
  public void alSourcePlayv(int ns, java.nio.IntBuffer sids);
  ...
  public void alSourceQueueBuffers(int sid, int numEntries, java.nio.IntBuffer bids);
  ...
  public void alSourceRewindv(int ns, java.nio.IntBuffer sids);
  ...
  public void alSourceStopv(int ns, java.nio.IntBuffer sids);
  ...
  public void alSourceUnqueueBuffers(int sid, int numEntries, java.nio.IntBuffer bids);
  ...
  public void alSourcefv(int sid, int param, java.nio.FloatBuffer values);
  ...
  public void alSourceiv(int sid, int param, java.nio.IntBuffer values);
