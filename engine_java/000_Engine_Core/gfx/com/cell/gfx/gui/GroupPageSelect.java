...
{
	static public UIRect HeadSelectedUI = UIRect.createBlankRect();
	static public UIRect HeadUnselectedUI = UIRect.createBlankRect();
	static public UIRect BackgroundUI = UIRect.createBlankRect();
	
	
	public class Page
	{
		private int Index;
		final public LabelBar Head;
		
		final public Vector<Item> Items = new Vector<Item>();
