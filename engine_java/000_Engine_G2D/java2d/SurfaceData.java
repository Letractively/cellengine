    ...
    implements Transparency, DisposerTarget, Surface
{
    ...
    /**
     * Helper function to set the dirty flag. For some surface
     * types (Custom, Any) we don't have the native data, so there's
     * no need to call setDirtyNative.
     */
    ...
    /**
     * Returns true if the surface is dirty; false otherwise.
     * @return whether the surface is dirty
     */
    ...
    /* Keep this in inner class to postpone initialization of AA pipeline */ 
    protected static class AA {
        public static final DuctusShapeRenderer colorShape;
        public static final PixelToParallelogramConverter colorViaShape;
        public static final PixelToParallelogramConverter colorViaPgram;
        public static final DuctusShapeRenderer clipColorShape;
        public static final PixelToParallelogramConverter clipColorViaShape;

        public static final DuctusShapeRenderer paintShape;
        public static final PixelToParallelogramConverter paintViaShape;
        public static final DuctusShapeRenderer clipPaintShape;
        public static final PixelToParallelogramConverter clipPaintViaShape;

        public static final DuctusShapeRenderer compShape;
        public static final PixelToParallelogramConverter compViaShape;
        public static final DuctusShapeRenderer clipCompShape;
        public static final PixelToParallelogramConverter clipCompViaShape;

        private static PixelToParallelogramConverter
            makeConverter(DuctusShapeRenderer renderer,
        ...
        static {
            colorShape = new DuctusShapeRenderer(colorPipe);
            colorViaShape = makeConverter(AA.colorShape);
            colorViaPgram = makeConverter(AA.colorShape, colorPipe);
            clipColorShape = new DuctusShapeRenderer(clipColorPipe);
            clipColorViaShape = makeConverter(AA.clipColorShape);

            paintShape = new DuctusShapeRenderer(paintPipe);
            paintViaShape = makeConverter(AA.paintShape);
            clipPaintShape = new DuctusShapeRenderer(clipPaintPipe);
            clipPaintViaShape = makeConverter(AA.clipPaintShape);

            compShape = new DuctusShapeRenderer(compPipe);
            compViaShape = makeConverter(AA.compShape);
            clipCompShape = new DuctusShapeRenderer(clipCompPipe);
            clipCompViaShape = makeConverter(AA.clipCompShape);
        }
    }
	...
	colorViaPgram = new PixelToParallelogramConverter(colorPrimitives,
                                                          colorPrimitives,
                                                          1.0, 0.25, true);
	...
	sg2d.imagepipe = imagepipe;
		...
		sg2d.loops = getRenderLoops(sg2d);
                ...
                if (sg2d.loops.fillParallelogramLoop != null) {
		...
		if (sg2d.clipState == sg2d.CLIP_SHAPE) {
		    sg2d.drawpipe = AA.clipCompViaShape;
		    sg2d.fillpipe = AA.clipCompViaShape;
		    sg2d.shapepipe = AA.clipCompViaShape;
		    sg2d.textpipe = clipCompText;
		} else {
		    sg2d.drawpipe = AA.compViaShape;
		    sg2d.fillpipe = AA.compViaShape;
		    sg2d.shapepipe = AA.compViaShape;
		...
		if (sg2d.clipState == sg2d.CLIP_SHAPE) {
            ...
            if (sg2d.alphafill != null) {
                if (sg2d.clipState == sg2d.CLIP_SHAPE) {
                    sg2d.drawpipe = AA.clipColorViaShape;
                    sg2d.fillpipe = AA.clipColorViaShape;
                    sg2d.shapepipe = AA.clipColorViaShape;
                ...
                if (sg2d.clipState == sg2d.CLIP_SHAPE) {
		    sg2d.drawpipe = AA.clipPaintViaShape;
		    sg2d.fillpipe = AA.clipPaintViaShape;
		    sg2d.shapepipe = AA.clipPaintViaShape;
		    sg2d.textpipe = clipPaintText;
		} else {
		    sg2d.drawpipe = AA.paintViaShape;
		    sg2d.fillpipe = AA.paintViaShape;
		    sg2d.shapepipe = AA.paintViaShape;
